...
class CamoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val listItems =
            mutableListOf(createAppMenuItem(R.drawable.ic_launcher_foreground, R.string.app_name))
        listItems.addAll(
            listOf(
                    createAppMenuItem(
                ...
                .sortedBy { requireContext().getString(it.textId) }
        )
        ...
        if (hasSamsungOneUI()) {
            ...
            tvSamsungOneUI.setOnClickListener {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q)
                    startActivity(
                        Intent(android.provider.Settings.ACTION_NOTIFICATION_ASSISTANT_SETTINGS)
                    )
    ...
    private fun createAppMenuItem(
        ...
        val item =
            OrbotMenuAction(appName, imageId, removeTint = true) {
                if (!isSelected) {
    ...
    companion object {
        fun getCamoMapping(context: Context): Map<String?, String> =
            mapOf<String?, String>(
                context.getString(R.string.app_name) to Prefs.DEFAULT_CAMO_DISABLED_ACTIVITY,
                context.getString(R.string.app_icon_chooser_label_fit_grit) to
                    "org.torproject.android.main.FitGrit",
                context.getString(R.string.app_icon_chooser_label_night_watch) to
                    "org.torproject.android.main.NightWatch",
                context.getString(R.string.app_icon_chooser_label_assistant) to
                    "org.torproject.android.main.Assistant",
                context.getString(R.string.app_icon_chooser_label_paint) to
                    "org.torproject.android.main.Paint",
                context.getString(R.string.app_icon_chooser_label_tetras) to
                    "org.torproject.android.main.Tetras",
                context.getString(R.string.app_icon_chooser_label_todo) to
                    "org.torproject.android.main.ToDo",
                context.getString(R.string.app_icon_chooser_label_birdie) to
                    "org.torproject.android.main.Birdie",
            )
    }
}
